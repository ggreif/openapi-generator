...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer EpisodeBase type
        public type JSON = {
            audio_preview_url : Text;
            description : Text;
            html_description : Text;
        ...
        public func toJSON(value : EpisodeBase) : JSON = value;

        // Convert JSON-facing Motoko type to Motoko-facing type
        public func fromJSON(json : JSON) : ?EpisodeBase = ?json;
    }
}
