...
module {
    ...
    public type QueueObjectCurrentlyPlaying = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer QueueObjectCurrentlyPlaying type
        public type JSON = {
            album : ?SimplifiedAlbumObject;
            artists : ?[SimplifiedArtistObject];
            available_markets : ?[Text];
        ...
        public func toJSON(value : QueueObjectCurrentlyPlaying) : JSON = value;

        // Convert JSON-facing Motoko type to Motoko-facing type
        public func fromJSON(json : JSON) : ?QueueObjectCurrentlyPlaying = ?json;
    }
}
