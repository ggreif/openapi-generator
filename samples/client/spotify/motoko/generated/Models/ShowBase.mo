...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ShowBase type
        public type JSON = {
            available_markets : [Text];
            copyrights : [CopyrightObject];
            description : Text;
        ...
        public func toJSON(value : ShowBase) : JSON = { value with
            type_ = ShowBaseType.toJSON(value.type_);
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ShowBase {
