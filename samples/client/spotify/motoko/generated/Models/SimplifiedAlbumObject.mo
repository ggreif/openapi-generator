...
// SimplifiedAlbumObject.mo

module {
    // User-facing type: what application code uses
    public type SimplifiedAlbumObject = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer SimplifiedAlbumObject type
        public type JSON = {
        ...
        public func toJSON(value : SimplifiedAlbumObject) : JSON = { value with
        ...
        public func fromJSON(json : JSON) : ?SimplifiedAlbumObject {
