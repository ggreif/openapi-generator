...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer AudiobookBase type
        public type JSON = {
            authors : [AuthorObject];
            available_markets : [Text];
            copyrights : [CopyrightObject];
        ...
        public func toJSON(value : AudiobookBase) : JSON = value;

        // Convert JSON-facing Motoko type to Motoko-facing type
        public func fromJSON(json : JSON) : ?AudiobookBase = ?json;
    }
}
